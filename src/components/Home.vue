      ...
      <div class="homeBg" v-else>
        ...
        <section class="activeIntro" v-if="showRuler">
          <div class="introBox">
            ...
            <p
              class="ruler"
            >1、参与方式：在各大分享平台（如微博、微信朋友圈、小红书等）晒出您对悦嘉丽[comfort zone]舒适地带产品的评价，并截图上传至“素人种草”活动；</p>
...
export default {
  ...
  data() {
    return {
      ...
      srcList: [
        {
          img: "http://newmedia.yokelly.com.cn/src/jifen/1.jpg"
        },
        {
          img: "http://newmedia.yokelly.com.cn/src/jifen/2.jpg"
        }
      ],
      showList1: [
        {
          img: "http://newmedia.yokelly.com.cn/src/jifen/01.jpg"
        },
        {
          img: "http://newmedia.yokelly.com.cn/src/jifen/02.jpg"
        },
        {
          img: "http://newmedia.yokelly.com.cn/src/jifen/03.jpg"
        }
      ],
      showAll: [
        {
        ...
        {
          img: "http://newmedia.yokelly.com.cn/src/jifen/04.jpg"
        },
        {
          img: "http://newmedia.yokelly.com.cn/src/jifen/06.jpg"
        },
        {
          img: "http://newmedia.yokelly.com.cn/src/jifen/07.jpg"
        }
      ],
      showImg: true,
      showRuler: false,
...
.home {
  ...
  width: 100%;
  .loadingPage {
    background: url("http://newmedia.yokelly.com.cn/src/jifen/bg1.jpg");
  ...
  .homeBg {
    background: url("http://newmedia.yokelly.com.cn/src/jifen/bg2.jpg");
    background-size: cover;
    height: 100%;
    width: 100%;
  }
