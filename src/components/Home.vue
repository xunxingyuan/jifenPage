      ...
      <div v-else>
        ...
        <section class="activeIntro" v-if="showRuler">
          <div class="introBox">
            ...
            <p class="ruler">1、活动时间：10月24日开始征集；11月05日-11月11日平台将择优参与投票评选活动；11月12日获奖公布；</p>
            <p class="ruler">2、活动奖品：投票活动中，票数最高的前10名，将获得价值1290元 素颜套装 10份（套装含：3支每日晶采爽肤水）；</p>
            <p class="ruler">3、参与方式：在各大分享平台（如微博、微信朋友圈、小红书等）晒出您对悦嘉丽[comfort zone]舒适地带产品的评价，并截图上传至“素人种草”活动，即可获得100积分；</p>
            <p class="ruler">4、每人每月最多可进行三次评论分享，每次成功晒图即可获得100积分；</p>
            <p class="ruler">5、晒图规则：不可重复上传相同内容，不可上传他人的晒图，否则会被判定审核不通过；</p>
            <p class="ruler">6、积分获取：嘉人们完成截图上传后，工作人员将在5个工作日内完成图片审核及积分发放，请您耐心等待；</p>
            <p class="ruler">7、积分用途：积分可用于兑换悦嘉丽官方微信积分商城的所有礼品；</p>
